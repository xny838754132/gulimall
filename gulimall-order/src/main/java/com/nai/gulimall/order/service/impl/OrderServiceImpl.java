...
public class OrderServiceImpl extends ServiceImpl<OrderDao, OrderEntity> implements OrderService {
    ...
    /**
     * 本地事务,在分布式系统下,只能控制住自己得回滚,控制不了其他服务得回滚
...
//    @GlobalTransactional
    ...
    public SubmitOrderResponseVo submitOrder(OrderSubmitVo orderSubmitVo) {
        ...
        //原子验证令牌和删除令牌
        Long result = redisTemplate.execute(new DefaultRedisScript<>(RedisConstant.SCRIPT, Long.class),
    ...
    private OrderItemEntity buildOrderItem(OrderItemVo orderItemVo) {
        ...
        BigDecimal realPrice = origin.subtract(itemEntity.getPromotionAmount())
